...
fn run_ai_help(json: bool) -> i32 {
    let help = AiHelp {
        ...
        safe_template: "codex-image generate --provider api --prompt \"<prompt>\" --output-dir ./artifacts/design --name <safe-stem> --n 1 --quality low --json",
        planning_template: "codex-image generate --provider api --prompt \"<prompt>\" --output-dir ./artifacts/design --prefix <safe-stem> --n 1 --quality low --dry-run --json",
        batch_template: "codex-image batch submit --provider api --prompt \"<prompt>\" --output-dir ./artifacts/design --prefix <safe-stem> --n 2 --quality low --job-file ./batch-job.json --json",
